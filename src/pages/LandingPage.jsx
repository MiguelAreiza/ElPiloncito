        ...
        <div className="landingPage">
            ...
            <div className="section home_section">
                ...
                <div className="fastOptions">
                    <Button name='Ver la Carta' icon='next' />
                    <Button name='Domicilios' icon='next' dark />
                    <Button name='Reservas' icon='next' />
                </div>
                ...
                <Button name='Ver la Carta' icon='next' onClick={handleclick} />
            </div>
